...
contextBridge.exposeInMainWorld('mkpAPI', {
  ...
  getGodModeRuntimeState: () => ipcRenderer.invoke('get-god-mode-runtime-state'),
  readGodModeLayoutState: () => ipcRenderer.invoke('read-god-mode-layout-state'),
  saveGodModeLayoutSnapshot: (payload) => ipcRenderer.invoke('save-god-mode-layout-snapshot', payload),
  restoreGodModeLayoutSnapshot: (target) => ipcRenderer.invoke('restore-god-mode-layout-snapshot', target),
  openGodModeLayoutFolder: () => ipcRenderer.invoke('open-god-mode-layout-folder'),
  freezeGodModeLayoutAsFormal: (payload) => ipcRenderer.invoke('freeze-god-mode-layout-as-formal', payload),
  ...
  getConvertedPresetsFolder: () => ipcRenderer.invoke('get-converted-presets-folder'),
  openConvertedPresetsFolder: () => ipcRenderer.invoke('open-converted-presets-folder'),
  convertTomlPresetToJson: () => ipcRenderer.invoke('convert-toml-preset-to-json'),
