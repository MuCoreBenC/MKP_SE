...
contextBridge.exposeInMainWorld('mkpAPI', {
  ...
  processGcodeWithGo: (gcodePath, tomlPath) => ipcRenderer.invoke('process-gcode-with-go', gcodePath, tomlPath),
  onGoProgress: (callback) => ipcRenderer.on('go-progress', (event, data) => callback(data))
