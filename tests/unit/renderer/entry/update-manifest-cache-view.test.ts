...
describe('update manifest cache view bridge', () => {
  it('exposes cached remote manifest from the modern update store for legacy updates page code', () => {
